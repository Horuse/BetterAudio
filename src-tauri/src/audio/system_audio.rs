...
#[cfg(target_os = "macos")]
pub fn load_app_icons(bundle_ids: Vec<String>) -> std::collections::HashMap<String, String> {
    macos::load_icons(bundle_ids)
}
...
#[cfg(not(target_os = "macos"))]
pub fn load_app_icons(_bundle_ids: Vec<String>) -> std::collections::HashMap<String, String> {
...
mod macos {
    ...
    pub fn load_icons(bundle_ids: Vec<String>) -> HashMap<String, String> {
